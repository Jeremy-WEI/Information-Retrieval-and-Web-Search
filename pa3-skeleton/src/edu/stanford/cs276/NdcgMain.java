...
/**
 * This is the class you can use to evaluate your ranking function on the
 * training data. You DO NOT need to modify this class.
 */
public class NdcgMain {
	public static void main(String[] args) throws IOException {
		if (args.length < 2) {
			System.out.println(
					"Please specify two files: (i) the ranked input file and (ii) the input file containing the relevance scores.");
			System.exit(1);
		}
