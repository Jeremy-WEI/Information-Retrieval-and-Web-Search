...
public class AndNot {
    ...
    static final String[][] mergeTestCases = {
            { "1; 2; 4; 5; 7; 13", "1; 4; 5; 6; 8; 10; 13", "[2, 7]" },
            { "1; 5", "1; 5", "[]" },
            { "1", "1", "[]" },
            { "1; 17; 21", "4; 5; 17; 21; 97; 108", "[1]" },
            { "5; 11; 12; 14; 15; 103", "3; 8; 11; 14; 15; 16; 18; 100; 103; 109", "[5, 12]" },
            { "1; 5; 11; 13; 19; 43", "2; 3; 5; 9; 11; 15; 19; 33; 45", "[1, 13, 43]" },
            { "1", "2; 189", "[1]" },
            {
    ...
    static List<Integer> merge(Iterator<Posting> p1, Iterator<Posting> p2) {
        ...
        while (true) {
            if (pp1 == null) break;
            if (pp2 == null || pp1.docID < pp2.docID) {
