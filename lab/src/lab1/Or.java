...
public class Or {
    ...
    /**
     * If true, loaded postings lists are printed; this just shows that they
    ...
    static final String[][] mergeTestCases = {
            { "1; 2; 4; 5; 7; 13", "1; 4; 5; 6; 8; 10; 13", "[1, 2, 4, 5, 6, 7, 8, 10, 13]" },
            { "1; 5", "1; 5", "[1, 5]" },
            { "1", "1", "[1]" },
            { "1; 17; 21", "4; 5; 17; 21; 97; 108", "[1, 4, 5, 17, 21, 97, 108]" },
            { "5; 11; 12; 14; 15; 103", "3; 8; 11; 14; 15; 16; 18; 100; 103; 109", "[3, 5, 8, 11, 12, 14, 15, 16, 18, 100, 103, 109]" },
            { "1; 5; 11; 13; 19; 43", "2; 3; 5; 9; 11; 15; 19; 33; 45", "[1, 2, 3, 5, 9, 11, 13, 15, 19, 33, 43, 45]" },
            { "1", "2; 189", "[1, 2, 189]" },
            {
                    "3;4;9;16;19;24;25;27;28;30;31;32;33;35;36;43;46;47;52;55;57;60;61;62;"
                            ...
                            + "952;955;961;962;963;968;971;973;975;979;980;983;984;987;989;993;995;996;" + "999", // "faculty" in first 1000 documents of Stanford crawl
                    ...
                    "[3, 4, 9, 16, 19, 24, 25, 27, 28, 30, 31, 32, 33, 35, 36, 43, 46, 47, 52, 55, 57, 60, "
                            ...
                            + "320, 321, 322, 324, 325, 326, 328, 329, 332, 334, 335, 337, 341, 342, 344, 345, "
                            + "347, 349, 356, 357, 358, 360, 364, 376, 377, 379, 382, 383, 385, 395, 397, 403, "
                            + "404, 405, 406, 410, 412, 417, 418, 423, 430, 431, 432, 433, 434, 437, 440, 441, "
                            + "445, 446, 452, 453, 454, 461, 464, 466, 469, 477, 480, 486, 487, 488, 495, 496, "
                            + "505, 506, 507, 511, 512, 517, 518, 520, 522, 524, 526, 532, 535, 540, 543, 549, "
                            ...
                            + "660, 668, 671, 676, 680, 681, 683, 686, 687, 689, 694, 697, 702, 703, 708, 710, "
                            ...
                            + "948, 952, 955, 961, 962, 963, 968, 971, 973, 975, 979, 980, 983, 984, 987, 989, " + "993, 995, 996, 999]" }, };

    /**
     * Stores the Posting for a single document: a docID and optionally a list
     * of document positions.
     */
     ...
     * (This is a more C-like method than idiomatic Java, but we use it so as to
     * be more parallel to the pseudo-code in the textbook.)
     */
     ...
     * level posting which is a list of integer docID separated by semicolons or
     * a positional postings list, where each docID is followed by a colon and
     * then
     * 
     * @param postingsString
     *            A String representation of a postings list
    ...
    /**
     * Main method. With no parameters, it runs some internal test cases. With
     * two postings list arguments, it or's the arguments given on the command
     * line. Otherwise, it will print a usage message.
     *
     * @param args
