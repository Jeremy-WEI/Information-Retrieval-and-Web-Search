...
/**
 * NoisyChannelModel class constructs a channel model (which is a model of
 * errors that occur in our dataset of queries - the probability of a character
 * getting inserted into a query, deleted from a query, substituted by another
 * character or transposed with a neighboring character in the query).
 * 
...
public class NoisyChannelModel implements Serializable {
    ...
    /*
     * Feel free to add more members here. Your code here ...
     */

    public double editProbability(String original, String R) {
        return ecm_.editProbability(original, R);
    }
    ...
    /**
     * Creates a new NoisyChannelModel object from the query corpus. This method
     * should be used to create a new object rather than calling the constructor
    ...
    public void setProbabilityType(String type) throws Exception {
        if (type.equals("empirical")) {
            ...
            throw new Exception("Invalid noisy channel probability type " + "- must be one of <uniform | empirical>");
        }
    }

    public static void main(String[] args) throws Exception {
        NoisyChannelModel ncm = NoisyChannelModel.create("/Users/YunchenWei/Documents/Coursera/IR/pa2-data/training_set/edit1s.txt");
        ncm.save();
    }
}
